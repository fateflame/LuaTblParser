...
if __name__ == "__main__":
    ...
    f = open('./LuaTableParser_testcase/testcaseraw.lua')
    test_str = f.read()
    ...
    for k,v in d3["root"].iteritems():
        if d3["root"][k]!= b1.dict["root"][k]:
            print d3["root"][k], b1.dict["root"][k]

    b2.loadDict(d1)
    b2.dumpLuaTable(file_path)
    b3.loadLuaTable(file_path)
